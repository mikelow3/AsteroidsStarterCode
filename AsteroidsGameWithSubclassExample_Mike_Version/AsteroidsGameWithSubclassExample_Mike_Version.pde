...
void chanceToCreateArcSteroid() {
  ...
  if (chanceOfAsteroid <= 5) {        // if it is (currently a 5% chance)
    ...
    if (edge < 25) {          // a roll of 0-24 represents the top of the screen  
      ...
      arrayListOfAsteroids.add(new Arcsteroid(random(width), 0, random(-2, 2), random(2, 6), 50, random(20, 150)));
    } else if (edge < 50) {    // a roll of 25-49 represents the bottom of the screen

      arrayListOfAsteroids.add(new Arcsteroid(random(width), height, random(-2, 2), random(-2, -6), 50, random(20, 150)));
    } else if (edge < 75) {    // a roll of 50-74 represents the left of the screen

      arrayListOfAsteroids.add(new Arcsteroid(0, random(height), random(2, 6), random(-2, 2), 50, random(20, 150)));
    }  else {                   // a roll of 75 and up represents the right of the screen
    
      arrayListOfAsteroids.add(new Arcsteroid(width, random(height), random(2, 6), random(-2, 2), 50, random(20, 150)));
    }
  }
}